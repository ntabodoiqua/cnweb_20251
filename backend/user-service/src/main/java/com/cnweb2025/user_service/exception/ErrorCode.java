...
public enum ErrorCode {
    ...
    SELLER_PROFILE_ALREADY_HAS_DOCUMENT(1909, "error.1909", HttpStatus.CONFLICT),
    SELLER_PROFILE_UPLOAD_DOCUMENT_FAILED(1910, "error.1910", HttpStatus.INTERNAL_SERVER_ERROR),
    SELLER_PROFILE_UPLOAD_DOCUMENT_EMPTY(1911, "error.1911", HttpStatus.BAD_REQUEST),
    SELLER_PROFILE_UPLOAD_DOCUMENT_INVALID_TYPE(1912, "error.1912", HttpStatus.BAD_REQUEST),
