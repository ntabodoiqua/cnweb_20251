...
public enum ErrorCode {
    ...
    ORDER_CANNOT_BE_RETURNED(1922, "error.1922", HttpStatus.BAD_REQUEST),
    RETURN_REASON_REQUIRED(1923, "error.1923", HttpStatus.BAD_REQUEST),
    RETURN_DESCRIPTION_REQUIRED(1924, "error.1924", HttpStatus.BAD_REQUEST),
    RETURN_ALREADY_REQUESTED(1925, "error.1925", HttpStatus.BAD_REQUEST),
    RETURN_NOT_REQUESTED(1926, "error.1926", HttpStatus.BAD_REQUEST),
    RETURN_ALREADY_PROCESSED(1927, "error.1927", HttpStatus.BAD_REQUEST),
    REJECTION_REASON_REQUIRED(1928, "error.1928", HttpStatus.BAD_REQUEST),
    ORDER_CANNOT_BE_REFUNDED(1929, "error.1929", HttpStatus.BAD_REQUEST),
    REFUND_FAILED(1930, "error.1930", HttpStatus.INTERNAL_SERVER_ERROR),
    RETURN_PERIOD_EXPIRED(1931, "error.1931", HttpStatus.BAD_REQUEST),
