...
public enum ErrorCode {
    ...
    PRODUCT_NOT_DELETED(1636, "error.1636", HttpStatus.BAD_REQUEST),
    ...
    ALREADY_FOLLOWING_STORE(1708, "error.1708", HttpStatus.CONFLICT),
    NOT_FOLLOWING_STORE(1709, "error.1709", HttpStatus.BAD_REQUEST),
    CANNOT_FOLLOW_OWN_STORE(1710, "error.1710", HttpStatus.BAD_REQUEST),
    ...
    ATTRIBUTE_VALUE_INACTIVE(1809, "error.1809", HttpStatus.BAD_REQUEST),
    
    // Lỗi Selection (185x) - Seller-defined selections
    SELECTION_GROUP_NOT_FOUND(1850, "error.1850", HttpStatus.NOT_FOUND),
    SELECTION_GROUP_NAME_REQUIRED(1851, "error.1851", HttpStatus.BAD_REQUEST),
    SELECTION_GROUP_NAME_EXISTS(1852, "error.1852", HttpStatus.CONFLICT),
    SELECTION_OPTION_NOT_FOUND(1853, "error.1853", HttpStatus.NOT_FOUND),
    SELECTION_OPTION_VALUE_REQUIRED(1854, "error.1854", HttpStatus.BAD_REQUEST),
    SELECTION_OPTION_VALUE_EXISTS(1855, "error.1855", HttpStatus.CONFLICT),
    SELECTION_OPTION_IDS_REQUIRED(1856, "error.1856", HttpStatus.BAD_REQUEST),
    VARIANT_ALREADY_LINKED_TO_OPTION(1857, "error.1857", HttpStatus.CONFLICT),
    VARIANT_NOT_LINKED_TO_OPTION(1858, "error.1858", HttpStatus.BAD_REQUEST),
    SELECTION_GROUP_NOT_BELONG_TO_PRODUCT(1859, "error.1859", HttpStatus.BAD_REQUEST),
