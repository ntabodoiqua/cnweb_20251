...
public enum ErrorCode {
    ...
    USER_DISABLED(1203, "User is disabled", HttpStatus.FORBIDDEN),
    USER_EXISTED(1204, "User already exists", HttpStatus.CONFLICT),
    USERNAME_INVALID(1205, "Username must be at least {min} characters", HttpStatus.BAD_REQUEST),
    INVALID_PASSWORD(1206, "Password must be at least {min} characters", HttpStatus.BAD_REQUEST),
    INVALID_DOB(1207, "User must be at least {min} years old", HttpStatus.BAD_REQUEST),
    INVALID_EMAIL(1208, "Email is invalid", HttpStatus.BAD_REQUEST),
    INVALID_PHONE(1209, "Phone number is invalid", HttpStatus.BAD_REQUEST),
    MISSING_USERNAME(1210, "Username is required", HttpStatus.BAD_REQUEST),
    MISSING_PASSWORD(1211, "Password is required", HttpStatus.BAD_REQUEST),
    USER_ALREADY_ENABLED(1212, "User is already enabled", HttpStatus.BAD_REQUEST),
    USER_ALREADY_DISABLED(1213, "User is already disabled", HttpStatus.BAD_REQUEST),
    ADMIN_CANNOT_DISABLE_SELF(1214, "Admin cannot disable themselves", HttpStatus.BAD_REQUEST),
    // Lỗi File (13xx)
    ...
    FILE_CANNOT_DELETED(1304, "File cannot be deleted.", HttpStatus.INTERNAL_SERVER_ERROR),
    FILE_IS_EMPTY(1305, "Uploaded file is empty.", HttpStatus.BAD_REQUEST),
